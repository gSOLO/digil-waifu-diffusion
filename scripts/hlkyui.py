...
parser.add_argument("--gfpgan-dir", type=str, help="GFPGAN directory", default='./GFPGAN') # webui.py
parser.add_argument("--realesrgan-dir", type=str, help="RealESRGAN directory", default=('./RealESRGAN')) # webui.py
        ...
        with gr.TabItem("Stable Diffusion Text-to-Image", id='txt2img_tab'):
            ...
            with gr.Row(elem_id='body').style(equal_height=False):
                with gr.Column():
                    ...
                    txt2img_batch_count = gr.Slider(minimum=1, maximum=16, step=1, label='Batch Count', value=txt2img_defaults['n_iter']) # webui.py
        ...
        with gr.TabItem("Stable Diffusion Image-to-Image", id="img2img_tab"):
            ...
            with gr.Row().style(equal_height=False):
                with gr.Column():
                    ...
                    img2img_batch_count = gr.Slider(minimum=1, maximum=250, step=1, label='Batch Count', value=img2img_defaults['n_iter']) # webui.py
