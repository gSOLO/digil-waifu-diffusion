...
#
# Use user styles located at /assets/webui/user.css
#   "user.css"
#   "assets/webui/user.css"
#
# Use notification sound located at /assets/webui/notification.mp3
#   "notification.mp3"
#   "assets/webui/notification.mp3"
#
# Use script located at /assets/webui/script.js
#   "script.js"
#   "assets/webui/script.js"
#
# Use javascript located at assets/webui/javascript
#   "javascript"
#   "assets/webui/javascript"
#
# Use textual inversion templates located at assets/webui/textual_inversion_templates   
#   "textual_inversion_templates"
#   "assets\webui\textual_inversion_templates"
        ...
        with gr.Row().style(equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Train"):
                    ...
                    template_file = gr.Textbox(label='Prompt template file', value=os.path.join(script_path, "assets\webui\textual_inversion_templates", "style_filewords.txt"))
...
""", file=sys.stderr)
    ...
    for cssfile in modules.scripts.list_files_with_name("assets/webui/style.css"):
    ...
    with gr.Blocks(css=css, analytics_enabled=False, title="Stable Diffusion") as demo:
        ...
        if os.path.exists(os.path.join(script_path, "assets/webui/notification.mp3")):
            audio_notification = gr.Audio(interactive=False, value=os.path.join(script_path, "assets/webui/notification.mp3"), elem_id="audio_notification", visible=False)
...
def load_javascript(raw_response):
    ...
    scripts_list = modules.scripts.list_scripts("assets/webui/javascript", ".js")
