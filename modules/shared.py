...
#
# Use artists db located at /assets/webui/artists.csv
#   'artists.csv'
...
parser.add_argument("--styles-file", type=str, help="filename to use for styles", default=os.path.join(script_path, 'assets/webui/styles.csv'))
parser.add_argument("--artists-file", type=str, help="filename to use for artists", default=os.path.join(script_path, 'assets/webui/artists.csv'))
...
artists_filename = cmd_opts.artists_file
artist_db = modules.artists.ArtistsDatabase(artists_filename)
